...
= ISA Roadmap (formerly Vexometer Roadmap)
...
Development roadmap for ISA (Irritation Surface Analyser, formerly Vexometer).
...
=== Sprint Update (2026-02-28)

* `Vexometer.Core`, `Vexometer.Patterns`, `Vexometer.Probes`, and `Vexometer.CII` package bodies are now implemented in-repo.
* A real Ada test harness now runs for those core packages via `just test`.
* External data loading parity is now in place: pattern/probe JSON files are ingested by `Load_From_File`.
* CLI subcommands (`analyse`, `probe`, `compare`, `report`) are now wired with real execution paths.
* Repository trust rotation now includes digest manifests (`.trust/trust-manifest.sha256`) and verification scripts.
...
|P0 |Implement `Vexometer.Patterns` package body *(Done 2026-02-28)* |Medium
|P0 |Compile and load pattern JSON files *(Done 2026-02-28)* |Low
...
|P0 |Implement `Vexometer.Core` package body *(Done 2026-02-28)* |Medium
...
|P0 |Implement `Vexometer.Probes` package body *(Done 2026-02-28)* |Medium
|P0 |Load probe definitions from JSON *(Done 2026-02-28)* |Low
...
|P0 |Implement `Vexometer.CII` - Completion Integrity Index *(Done 2026-02-28)* |Medium
...
|P0 |Implement `Run_Probe_Suite` procedure *(Done 2026-02-28)* |Medium
|P0 |Add progress callback support |Low
|P1 |Implement `Compare_Models` for multi-model comparison *(Done 2026-02-28)* |Medium
...
|P0 |Implement JSON report generation *(Done 2026-02-28)* |Low
|P0 |Implement Markdown report generation *(Done 2026-02-28)* |Low
