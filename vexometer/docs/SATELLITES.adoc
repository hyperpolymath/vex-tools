...
= ISA Satellite Architecture (formerly Vexometer Satellite Architecture)
:toc: left
:toclevels: 3
:icons: font
...
ISA is a *diagnostic instrument* - it measures AI assistant irritation
...
* *Scope discipline* - ISA avoids feature creep

Naming compatibility note: integration protocol IDs remain `vexometer-*` for backwards compatibility.
...
* link:METRICS.adoc[Metrics Reference] - All 10 ISA metrics (vexometer identifiers)
