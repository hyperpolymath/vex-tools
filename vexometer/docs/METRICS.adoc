...
= ISA Metrics Reference (formerly Vexometer Metrics Reference)
:toc: left
:toclevels: 3
:icons: font
...
ISA measures ten dimensions of AI assistant irritation surfaces.
All metrics are normalised to a 0-1 scale where *lower is better*.

Technical compatibility note: metric package and protocol identifiers continue to use the `vexometer` prefix.
