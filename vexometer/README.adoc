...
*ISA* is the canonical product name.
*Vexometer* is the legacy codename retained for compatibility in technical identifiers such as `vexometer/`, `vexometer.gpr`, the `vexometer` CLI command, and `Vexometer.*` Ada packages.
