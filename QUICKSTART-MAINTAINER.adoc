...
// Replace vex-tools, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= vex-tools — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining vex-tools for
...
* Upstream: https://github.com/hyperpolymath/vex-tools/issues
