...
= Contributing — vex-tools
:revdate: 2026-MM-DD

== Audience

Developers working *on* `vex-tools`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/vex-tools.git
cd vex-tools
...
* Bugs in `vex-tools`: file at `hyperpolymath/vex-tools/issues`.
