...
// Replace vex-tools, Vex Tools — See README.adoc for details., just run, Vex Tools started successfully. with actuals
= vex-tools — Quick Start for Users
:toc:
:toclevels: 2

== What is vex-tools?

Vex Tools — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./vex-tools-portable
----
...
[source]
----
Vex Tools started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/vex-tools/wiki
